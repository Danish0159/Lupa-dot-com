...
const Reserve = () => {
  ...
  useEffect(() => {
    const fetchReserveList = async () => {
      try {
        const response = await fetch(`https://fypbookingbea.adaptable.app/api/reserve/${user._id}`);
  ...
  const filteredCars = [
    {
      ...
      "address": "https://www.google.com/maps/place/Nabeel+Medical+Store/@31.5409617,74.3024803,17z/data=!3m1!4b1!4m6!3m5!1s0x3919035eb8792341:0x9564858ddb947a3d!8m2!3d31.5409618!4d74.3073512!16s%2Fg%2F11f40z990d?entry=ttu",
      "CNIC": 349292837465,
      "price": 2500,
      "maxSeats": 3,
      "phone": 3062188622,
  ...
  const item =
  {
    ...
    "rooms": [
      "63a1bff4d3a9d03515a0e168",
      "64867b740a5f8e60e559cf13"
    ],
    "cheapestPrice": 100,
    "featured": true,
    "__v": 0
      ...
      <div className="hotelParent">
            ...
            <div className="hotelContainer">
              <div className="hotelsearchItem">
                ...
                <div className="hotelsiDesc">
                  ...
                  <span className="hotelsiDistance">{item.hotel.distance}m from center</span>
                ...
                <div className="hotelsiDetails">
                  {item.hotel.rating && <div className="hotelsiRating">
                    <span>Excellent</span>
        ...
        {room && room.map((item) => {
          return (
            <div className="hotelContainer">
              <div className="hotelsearchItem">
                <img src="https://res.cloudinary.com/dm1mlee94/image/upload/v1686534250/dnpp7rmn7h7rtujcbnpb.jpg" alt="" className="siImg" />
                <div className="hotelsiDesc">
                  <h1 className="hotelsiTitle">{item.room.title}</h1>
                  <span className="hotelsiDistance">price: {item.room.price}</span>
                  <span className="hotelsiSubtitle">
          ...
          {cars && cars.map((item) => (
            <li key={item.car.id}>
              ...
              <div className="car-info">
                ...
                <p className="car-info">Price Per Hour: {item.car.price}/Rs</p>
